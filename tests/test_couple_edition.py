...
class TestCoupleSettings:
    ...
    def test_is_couple_configured(self, temp_db):
        ...
        save_couple_settings(
            member_a_id=member_a_id, member_b_id=member_b_id, current_user_id=member_a_id
        )
...
class TestCardMappings:
    ...
    def test_save_and_get_card_mapping(self, temp_db):
        ...
        # Sauvegarder
        result = save_card_mapping(card_suffix="1234", account_type="PERSONAL_A", label="Ma carte")
        assert result is True
