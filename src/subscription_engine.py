...
from src.data_cleaning import clean_transaction_label
...
class SubscriptionDetector:
    ...
    def detect_subscriptions(
        ...
        for merchant, group in data.groupby("clean_merchant"):
            ...
            # Analyser ce groupe
            subscription = self._analyze_merchant_group(
                merchant, group, reference_date
            )
    ...
    def _analyze_merchant_group(
        ...
        last_date = dates[-1]
        status = self._determine_status(frequency, last_date, reference_date, amount_std, avg_amount)
