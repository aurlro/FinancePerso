"""Configuration mode manager - LEGACY WRAPPER.

DEPRECATED: This module is kept for backward compatibility.
Use the new configuration page structure directly.
"""
...
warnings.warn(
    "modules.ui.config.config_mode is deprecated. "
    "Use the new configuration page structure directly.",
    DeprecationWarning,
    stacklevel=2,
)
...
def get_simplified_api_form() -> dict:
    """
...
def get_simplified_notification_form() -> dict:
    """
...
def render_simple_mode_help() -> None:
...
__all__ = [
    ...
    "toggle_config_mode",
    "render_mode_toggle",
    "should_show_advanced_section",
    "get_simplified_api_form",
    "get_simplified_notification_form",
    "filter_categories_for_simple_mode",
