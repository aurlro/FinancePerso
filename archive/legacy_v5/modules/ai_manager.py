"""
AI Manager - DEPRECATED
=======================

⚠️ This module is deprecated and kept for backward compatibility.
Please use modules.ai_manager_v2 instead.

The new module uses the modern google.genai API (v2) instead of the
deprecated google.generativeai API.

Migration:
    OLD: from modules.ai_manager import get_ai_provider
    NEW: from modules.ai_manager_v2 import get_ai_provider
...
warnings.warn(
    "modules.ai_manager is deprecated. Use modules.ai_manager_v2 instead.",
    DeprecationWarning,
    stacklevel=2,
)
