...
Horizontal avatar selector for user/member selection.

Migrated from: modules/ui/components/avatar_selector.py
Classification: Molecule (interactive selector)
"""
