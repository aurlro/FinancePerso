...
Migrated from: modules/ui/components/tag_manager.py
Classification: Molecule (complex composite with pills, selectors, and propagation)
"""
                ...
                if not similar_df.empty:
                    ...
                    if missing_tags_tx:
                        ...
                        if len(missing_tags_tx) > 1:
                            if st.button(
                                f"🏷️ Taguer toutes les {len(missing_tags_tx)} transactions",
                                type="primary",
                                use_container_width=True,
