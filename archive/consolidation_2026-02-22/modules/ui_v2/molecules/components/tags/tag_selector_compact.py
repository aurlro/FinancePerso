...
Migrated from: modules/ui/components/tag_selector_compact.py
Classification: Molecule (compact composite selector)
"""
...
def render_cheque_nature_field(
    transaction_id: int, current_nature: str = "", key_suffix: str = ""
) -> str:
    """
