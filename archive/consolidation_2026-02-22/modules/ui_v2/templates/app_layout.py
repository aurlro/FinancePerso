"""App Layout Components - Layouts globaux de l'application.

Contient les éléments structurels réutilisés sur plusieurs pages
comme la sidebar, les entêtes, et les informations d'application.
"""
