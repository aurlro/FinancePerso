...
USE_V5_6_INTERFACE = True  # Active la nouvelle interface V5.6 (light mode, design FinCouple)
TEST_DASHBOARD_ENABLED = True  # Active la page Test_Dashboard V5.6 en production
