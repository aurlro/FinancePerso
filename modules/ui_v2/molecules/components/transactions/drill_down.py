...
Migrated from: modules/ui/components/transaction_drill_down.py
Classification: Molecule (complex transaction display and editing)
"""
...
def _render_transaction_row_compact(
    ...
    with cols[4]:
        ...
        if current_tags:
            from modules.ui_v2.molecules.components.tags import render_pill_tags

            render_pill_tags(current_tags, size="small", removable=False)

        # Smart tag selector with propagation
        from modules.ui_v2.molecules.components.tags import render_smart_tag_selector
    ...
    if is_cheque:
        with st.container():
            ...
            with nature_cols[1]:
                from modules.ui_v2.molecules.components.tags import render_cheque_nature_field
