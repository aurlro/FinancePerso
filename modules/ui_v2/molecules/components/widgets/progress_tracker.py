...
Migrated from: modules/ui/components/progress_tracker.py
Classification: Molecule (progress indicator widget)
"""
...
# Alias for compatibility with loading_states module
clear_operation_progress = reset_progress_tracker
_clear_operation_progress = reset_progress_tracker  # Keep private alias too
