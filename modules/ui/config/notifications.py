                ...
                if results["errors"]:
                    for error in results["errors"]:
                        ...
                        if "Authentification" in error:
                            st.info(
                                "💡 **Pour Gmail:** Utilisez un 'App Password' généré sur https://myaccount.google.com/apppasswords"
                            )
                        elif "connecter" in error.lower():
                            st.info(
                                "💡 Vérifiez que le serveur SMTP et le port sont corrects (Gmail: smtp.gmail.com:587)"
                            )
