...
def calculate_kpis(month_str: str) -> List[KPIData]:
    ...
    savings_mask = df_month['category_validated'].str.contains('épargne|objectif|savings|goal', case=False, na=False)
...
def _get_empty_kpis() -> List[KPIData]:
    ...
    return [
        KPIData(label="Reste à vivre", value="0,00 €", value_color="neutral", icon="💚", icon_bg="#DCFCE7"),
        KPIData(label="Dépenses", value="0,00 €", value_color="neutral", icon="💳", icon_bg="#FEE2E2"),
        KPIData(label="Revenus", value="0,00 €", value_color="neutral", icon="📈", icon_bg="#DBEAFE"),
        KPIData(label="Épargne", value="0,00 €", value_color="neutral", icon="🎯", icon_bg="#F3E8FF"),
    ]
