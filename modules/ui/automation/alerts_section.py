...
class SubscriptionAlert:
    ...
    def __init__(self, type: str, merchant: str, message: str, severity: str = "info", data: dict = None):
...
def _render_alert_card(alert: SubscriptionAlert):
    ...
    with st.container(border=True):
        ...
        with cols[2]:
            if st.button("👀 Voir détails", key=f"alert_{alert.merchant[:20]}", use_container_width=True):
