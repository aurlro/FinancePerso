    ...
    for _, problem in problems.iterrows():
        with st.container(border=True):
            ...
            with col3:
                ...
                st.markdown("**→**")
                st.markdown(f"<span style='color:blue;font-size:1.5em'>{new_amount:,.2f} €</span>", unsafe_allow_html=True)
...
def render_transaction_diagnostic_page():
    ...
    with tabs[2]:
        st.info("🚧 Fonctionnalité à venir : correction automatique de toutes les transactions incohérentes.")
