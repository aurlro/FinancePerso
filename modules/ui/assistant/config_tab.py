...
def render_subscriptions():
    ...
    with col1:
        card_kpi("Budget Mensuel", f"{abs(monthly_total):.2f} €", trend="Fixe", trend_color="neutral")
    with col2:
    ...
    st.caption("*Basé sur la régularité des paiements (intervalle ~30 jours) et la constance du montant.*")
