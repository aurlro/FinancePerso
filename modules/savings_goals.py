...
class SavingsGoal:
    ...
    deadline: Optional[str]  # ISO format YYYY-MM-DD
    emoji: str
    color: str  # hex color
    description: str
    created_at: str
    ...
    @property
    def monthly_needed(self) -> Optional[float]:
...
class SavingsGoalsManager:
    ...
    def get_closest_goal(self) -> Optional[SavingsGoal]:
...
# Singleton instance
_goals_manager: Optional[SavingsGoalsManager] = None
...
def get_closest_savings_goal() -> Optional[SavingsGoal]:
