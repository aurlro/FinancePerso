...
class DashboardCleanupManager:
    ...
    DEFAULT_LAYOUT_JSON = [
        {"id": "kpi_1", "type": "kpi_depenses", "title": "💸 Dépenses", "position": 1, "size": "small", "visible": True, "config": {}},
        ...
        {"id": "evol_1", "type": "evolution_chart", "title": "📈 Évolution", "position": 5, "size": "large", "visible": True, "config": {}},
    ...
    VALID_WIDGET_TYPES = {
        'kpi_depenses', 'kpi_revenus', 'kpi_solde', 'kpi_epargne',
        'evolution_chart', 'savings_trend', 'categories_chart', 'top_expenses',
        'budget_tracker', 'budget_alerts', 'smart_recommendations',
        'monthly_stacked', 'members_analysis', 'tiers_analysis',
        'tags_analysis', 'ai_insights'
    }
