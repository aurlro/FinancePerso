...
from .models import Notification, NotificationAction, NotificationLevel, NotificationPreferences, NotificationType
...
class NotificationRepository:
        ...
        with get_db_connection() as conn:
            ...
            if not cursor.fetchone():
                raise RuntimeError(
                    ...
                    "Run migration 007_notifications.sql first."
                )
    ...
    def _row_to_notification(self, row) -> Notification:
        ...
        return Notification(
            ...
            category=row[10],
            source=row[11],
            actions=[NotificationAction.from_dict(a) for a in json.loads(row[12])] if row[12] else [],
