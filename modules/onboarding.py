...
class OnboardingManager:
    ...
    def is_first_time(self) -> bool:
        ...
        try:
            ...
            has_no_transactions = transactions.empty if hasattr(transactions, 'empty') else len(transactions) == 0
            has_no_categories = len(categories) == 0 if isinstance(categories, list) else categories.empty
            
            return (has_no_transactions and has_no_categories) and not st.session_state.get('onboarding_completed', False)
    ...
    def render_step_2_import(self):
        ...
        st.info("💡 **Conseil** : Commencez par importer vos relevés des 3 derniers mois pour avoir une vision complète de vos finances.")
