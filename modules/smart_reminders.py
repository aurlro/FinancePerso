...
class SmartReminder:
    ...
    action_target: Optional[str] = None  # page path or action name
...
class SmartReminderEngine:
    ...
    def _check_import_reminder(self):
        ...
        try:
            ...
            if df.empty:
                ...
                self.reminders.append(SmartReminder(
            ...
            if days_since > 10:
                self.reminders.append(SmartReminder(
                    type=ReminderType.IMPORT_REMINDER,
                    title=f"📥 Nouveau relevé à importer ?",
    ...
    def _check_rule_suggestions(self):
        ...
        try:
            ...
            missing_rules = [
                (label, count) for label, count in frequent
