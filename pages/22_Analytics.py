...
tab_overview, tab_metrics, tab_events = st.tabs(["Vue d'ensemble", "Métriques métier", "Événements bruts"])
...
with tab_overview:
    ...
    with col3:
        ...
        st.metric(
            "Événements totaux",
            f"{events_30d.get('total_events', 0)}"
        )
